...
const sliderThumbStyle = cva(
  "cursor-pointer rounded-full border-[3px] border-primary-400 bg-white transition-colors hover:bg-neutral-400 disabled:pointer-events-none disabled:opacity-50",
  {
    variants: {
      orientation: {
