...
>((props, ref) => (
  <TooltipPrimitives.Positioner>
    <TooltipPrimitives.Content
      ref={ref}
      className="z-50 block max-w-52 overflow-hidden rounded border border-gray-900 bg-gray-900 px-3 py-1.5 text-sm font-medium text-white shadow-md transition-all duration-200 data-[state=closed]:opacity-0 data-[state=open]:opacity-100"
      {...props}
    />
  </TooltipPrimitives.Positioner>
));
