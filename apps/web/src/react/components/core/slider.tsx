...
const sliderThumbStyle = cva(
  "cursor-pointer rounded-full border-[3px] border-indigo-400 bg-white transition-colors hover:bg-gray-100 disabled:pointer-events-none disabled:opacity-50",
  {
    variants: {
      orientation: {
