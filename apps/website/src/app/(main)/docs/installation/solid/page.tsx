...
export const metadata: Metadata = {
  title: "Installation for solid js",
};

const SolidInstallationPage = () => {
  return (
    <>
      <DocText level="titleOne">Installation for solid js</DocText>
      <DocText level="paragraphTwo">
      How to use djamla with solid js
      </DocText>
      ...
      <PackageManagerTabs>
        <PackageManagerTabContent value="npm">
          <SyntaxHighlighter>npm install @ark-ui/solid</SyntaxHighlighter>
        </PackageManagerTabContent>
        <PackageManagerTabContent value="yarn">
          <SyntaxHighlighter>yarn add @ark-ui/solid</SyntaxHighlighter>
        </PackageManagerTabContent>
        <PackageManagerTabContent value="pnpm">
          <SyntaxHighlighter>pnpm add @ark-ui/solid</SyntaxHighlighter>
        </PackageManagerTabContent>
        <PackageManagerTabContent value="bun">
          <SyntaxHighlighter>bun add @ark-ui/solid</SyntaxHighlighter>
        </PackageManagerTabContent>
      </PackageManagerTabs>
      ...
      <PackageManagerTabs>
        <PackageManagerTabContent value="npm">
          <SyntaxHighlighter>npm install @tabler/icons-solidjs</SyntaxHighlighter>
        </PackageManagerTabContent>
        <PackageManagerTabContent value="yarn">
          <SyntaxHighlighter>yarn add @tabler/icons-solidjs</SyntaxHighlighter>
        </PackageManagerTabContent>
        <PackageManagerTabContent value="pnpm">
          <SyntaxHighlighter>pnpm add @tabler/icons-solidjs</SyntaxHighlighter>
        </PackageManagerTabContent>
        <PackageManagerTabContent value="bun">
          <SyntaxHighlighter>bun add @tabler/icons-solidjs</SyntaxHighlighter>
        </PackageManagerTabContent>
      </PackageManagerTabs>
...
export default SolidInstallationPage;
